...
using TeSoft.Api.API.Common.Attributes;
using TeSoft.Api.API.Common.Settings;
using TeSoft.Api.API.Swagger;
using TeSoft.Api.IoC.Configuration.DI;

#pragma warning disable CS1591
namespace TeSoft.Api.API
{
            ...
            try
            {
                if (_appSettings.IsValid())
                {
                    ...
                    options =>
                    {
                        ...
                        // can also be used to control the format of the API version in route tesoft.apis
